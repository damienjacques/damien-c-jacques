...
This notebook aims to explore the statistical meaning behind the *data fusion* proposed in [Pokhriyal, 2017](http://www.pnas.org/content/114/46/E9783).

For this purpose, let us first generate some gaussian distributions.
...
We combine both gaussians following the procedure described in [Pokhriyal, 2017](http://www.pnas.org/content/114/46/E9783).
...
Now, we can study different cases. 
