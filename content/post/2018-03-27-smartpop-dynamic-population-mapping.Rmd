...
A [shiny app](https://smartpop.shinyapps.io/ExploreAntenna/) was developped to check each antenna with less than 365 active days (609), one by one and create a lookup table to merge the antennas depending on their time series.
